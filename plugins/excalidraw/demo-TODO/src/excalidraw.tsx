...
import type {AutomergeList} from "../../../web/src/types"
import type {ContentView} from "../../../web/src/contents/types/type-registries"
import * as coders from "../../../web/src/contents/types/coders"

// should i provide this from @littlebook/plugin?
// probably, right! like, plus any other types i create with crdx?
