...
export interface FileEditor<Shape = unknown> extends FileViewBase<Shape, FileEditorAPI<Shape>> {
    category: "editor";
}
export interface FileViewer<Shape = unknown> extends FileViewBase<Shape, FileViewerAPI<Shape>> {
    category: "readonly";
}
...
export type View<Shape = unknown> = FileEditor<Shape> | FileViewer<Shape> | StandaloneView;
export {};
